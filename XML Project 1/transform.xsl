...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:key name="twitter" match="tweet" use="user"/>
          ...
          <xsl:for-each select="data/users/user">
            <div class="card border-primary mb-2" style="max-width: 18rem;">
              ...
              <div class="card-body">
                ...
                Average likes:  
                <span class="badge bg-secondary ms-1"><xsl:value-of select="sum(key('twitter', id)/likes) div count(key('twitter', id))"/></span>
                </p>
              </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <ol class="list-group">
                    <xsl:for-each select="key('twitter', id)">
